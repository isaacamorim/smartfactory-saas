# factory_saas/routers/parametros_router.py
...
def obter_parametros(
    ...
    if not params:
        raise HTTPException(
            status_code=404, detail="Parâmetros não configurados para esta máquina"
        )
    return params
