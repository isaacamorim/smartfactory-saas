...
export default function Navbar({ page, user, onLogout }) {
  ...
  return (
    <header style={{
      ...
      {/* Live ticker strip */}
      <div style={{ overflow: "hidden", width: 340, borderLeft: "1px solid var(--border)", borderRight: "1px solid var(--border)", padding: "0 12px" }}>
        <div style={{
      ...
      <div style={{ display: "flex", gap: 8, alignItems: "center", borderLeft: "1px solid var(--border)", paddingLeft: 14 }}>
        ...
        <div className="hex" style={{
          width: 30, height: 30,
          background: "linear-gradient(135deg,var(--cyan2),#005577)",
          display: "flex", alignItems: "center", justifyContent: "center",
          fontSize: 11, fontWeight: 700, color: "var(--bg0)", cursor: "pointer",
        }}>
