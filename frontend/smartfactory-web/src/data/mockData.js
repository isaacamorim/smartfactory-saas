...
// Em produção substitua pelos fetch() da sua API FastAPI
...
export const EMPRESAS = [
  { id:1, nome:"NH Alimentos", cnpj:"12.345.678/0001-90", maquinas:3, usuarios:5, criado_em:"2024-01-10" },
];

export const OEE_WORLD_CLASS = {
  oee:          85,
  disponibilidade: 90,
  performance:  95,
  qualidade:    99.9,
